...
import dogData from "../../data/dogs.data"; 
...
const Intro = () => {
  ...
  const filteredDogs = dogData.filter((dog) => {
    const matchesSearch =
      ...
      dog.age.toLowerCase().includes(search.toLowerCase()) ||
      dog.gender.toLowerCase().includes(search.toLowerCase());

    const matchesSize = selectedSize ? dog.size === selectedSize : true;
    const matchesGender = selectedGender ? dog.gender === selectedGender : true;
